...
pair<Point, Point> closestPairUtil(vector<Point> &points, int left,
                                   int right)
{
  ...
  // Temukan pasangan terdekat di kedua bagian kiri dan kanansecara rekursif
  ...
  double minDist;
  if (dist(closestLeft.first, closestLeft.second) < dist(closestRight.first, closestRight.second))
  {
